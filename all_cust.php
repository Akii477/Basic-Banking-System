...
<body style="background-image:url('statics/Home.jpg');">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap active" href="all_cust.php"><h4>View All Customers</h4></a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                ...
                <h1 style=" color:#FFBD;">All Customers</h1>
            </div>
            <?php
