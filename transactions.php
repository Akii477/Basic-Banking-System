...
<body style="background-image:url('statics/trans.jpg');background-size:cover;background-attachment:fixed;width:100%;height
:auto">
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                ...
                <h1 style=" color:#FFBD29;">Transactions Details</h1>
            </div>
            <?php
