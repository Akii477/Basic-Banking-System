...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="statics/logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/logo.png">
...
<body style="background-color:#10CAFF;">
...
<div id="container">
            ...
            <b>
                <ul class="navbar-nav ">
                    <li class="nav-item nav-links" style="margin-left:15px;">
                        <a class="nav-link active text-nowrap" aria-current="page" href="index.php"><h4>Home</h4></a>
                    </li>
    ...
    <div class="container-large"
        style="color:white;  padding:4% 2% 2% 2%; background-color:#212529;">
        
    </div>
    <img src="statics/Home.jpg" alt="" style="width:100%; position:absolute; z-index:-1">

    <center style="margin:100px 0px 10px 0px;"><h1 style="text-shadow:2px 2px 2px white; color:#FFBD29;"><b>Sparks Bank Amazing Facilities</b></h1></center>
    <center style="margin:150px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(10px); box-shadow:5px 5px 10px white; border-radius:30px; padding:20px 0px 20px 0px;">
            
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#fb2525; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
