...
<body style="background-image:url('statics/Home.jpg'); padding-top:8%;">
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; ">
                        <a class="nav-link text-nowrap active" href="send_money.php"><h4>Send Money</h4></a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                ...
                <h1 style=" color:#FFBD29;">Transfer Money</h1>
            </div>
            <br><br>
            <div class="" style=" backdrop-filter: blur(50px);  border-radius:5px;  ">
